...
public interface PlanningReceivingAllocationFacadeRemote {
    ...
    List<Object[]> findPlanningReceivingAllocationsByMapping(String booking_code);
     ...
     Integer findValidasiConstraint(String no_ppkb,int cont_size, int cont_type, String cont_status, String over_size,String dg,String isExport, String gross_class , String port_code);
