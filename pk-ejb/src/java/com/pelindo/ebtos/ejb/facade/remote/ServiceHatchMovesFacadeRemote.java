...
public interface ServiceHatchMovesFacadeRemote {
    ...
    int count();
     ...
     List<Object[]> findServiceHatchMovesByPpkbOperationDischarge(String no_ppkb,String operation);
     //penambahan pemilihan load by ade chelsea 8 april 2014
     List<Object[]> findServiceHatchMovesByPpkbOperationLoad(String no_ppkb,String operation);
