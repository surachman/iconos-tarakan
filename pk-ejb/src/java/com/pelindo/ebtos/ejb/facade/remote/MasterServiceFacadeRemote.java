...
public interface MasterServiceFacadeRemote {
    ...
    //List<MasterService> findSelectService();

    List<MasterService> findRange(int[] range);

    List<Object[]> findMasterServices();
    
    List<Object[]> findSelectServiceDelivery();
    
    List<Object[]> findSelectServiceDeliveryUC();
    
    List<Object[]> findSelectService();
    
    List<Object[]> findSelectServiceUC();
