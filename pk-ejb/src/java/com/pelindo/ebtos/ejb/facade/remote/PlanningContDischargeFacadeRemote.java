...
public interface PlanningContDischargeFacadeRemote {
    ...
    List<Integer> findBaplieByConstraint (int cont_type, String cont_status, String gross_class, String commodity, String dg, String overSize, String isImport,String no_ppkb);
