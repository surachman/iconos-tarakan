 ...
 */
@Local
public interface MasterActivityFacadeLocal {
    ...
    public String translatePluggingActivityCode(short contSize);

    public String translateMonitoringActivityCode(short contSize);
