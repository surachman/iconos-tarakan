...
public interface MasterActivityFacadeRemote {
    ...
    public String translateStevedoringActivityCode(String contType, Short contSize, 
            String crane, Boolean overSize, String equipmentType,
            Boolean dangerous, Boolean hasLabel, String dangerousClass,
            Boolean seling, Boolean twentyOneFeet);
    ...
    public String translateOtherHandlingChargesActivityCode(String contType, Short contSize, 
            String crane, Boolean overSize, String equipmentType,
            Boolean dangerous, Boolean hasLabel, String dangerousClass,
            Boolean seling, Boolean twentyOneFeet);

    String translateLoLoActivityCode(String contType, Short contSize, 
            Boolean overSize, Boolean dangerous, 
            Boolean hasLabel, String dangerousClass, String equipmentType);
    ...
    public java.lang.String translateAngkutActivityCode(String contStatus, Short contSize);
    ...
    public java.lang.String translateDischargeToLoadActivityCode(int contSize, String contType);
