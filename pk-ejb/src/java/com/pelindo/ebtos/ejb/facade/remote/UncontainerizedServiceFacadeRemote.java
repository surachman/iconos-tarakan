...
public interface UncontainerizedServiceFacadeRemote {
    ...
    Object[] findByPpkbAndBlNoMobile(String no_ppkb, String bl_no, String status, String operation, Integer is_delivery);

    Object[] findByBlNoMobile(String bl_no, String status, String operation, Integer is_delivey);

    List<Object[]> findDeliveredUcsByNoPpkb(String no_ppkb);

    List<Object[]> findDeliverableUcs(String no_ppkb);
    
    List<Object[]> findDeliverableUcs2();
    ...
    public com.pelindo.ebtos.model.db.UncontainerizedService findUcByStatusOperationAndDeliveryStatus(java.lang.String noPpkb, java.lang.String blNo, java.lang.String status, java.lang.String operation, java.lang.Integer isDelivery);
