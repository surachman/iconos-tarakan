 ...
 * @author x42jr
 */
public class DischargeConfirmInitialData implements Serializable, IMessageable {
    ...
    public DischargeConfirmInitialData(){}

    public DischargeConfirmInitialData(String code, String message) {
