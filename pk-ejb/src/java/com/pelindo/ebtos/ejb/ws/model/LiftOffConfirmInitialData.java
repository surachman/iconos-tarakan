 ...
 * @author x42jr
 */
public class LiftOffConfirmInitialData implements Serializable, IMessageable {
    ...
    public LiftOffConfirmInitialData(){}

    public LiftOffConfirmInitialData(String code, String message) {
