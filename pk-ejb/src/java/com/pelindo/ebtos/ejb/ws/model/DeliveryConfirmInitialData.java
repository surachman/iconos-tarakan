 ...
 * @author x42jr
 */
public class DeliveryConfirmInitialData implements Serializable, IMessageable {
    ...
    public DeliveryConfirmInitialData(){}

    public DeliveryConfirmInitialData(String code, String message) {
