 ...
 * @author x42jr
 */
public class LoadUcConfirmInitialData implements Serializable, IMessageable {
    ...
    public LoadUcConfirmInitialData(){}

    public LoadUcConfirmInitialData(String code, String message) {
