 ...
 * @author x42jr
 */
public class ContainerMovementOffConfirmInitialData implements Serializable, IMessageable {
    ...
    public ContainerMovementOffConfirmInitialData(){}

    public ContainerMovementOffConfirmInitialData(String code, String message) {
