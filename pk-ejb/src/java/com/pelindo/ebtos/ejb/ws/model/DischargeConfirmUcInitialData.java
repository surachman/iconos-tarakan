 ...
 * @author x42jr
 */
public class DischargeConfirmUcInitialData implements Serializable, IMessageable {
    ...
    public DischargeConfirmUcInitialData(){}

    public DischargeConfirmUcInitialData(String code, String message) {
