 ...
 * @author x42jr
 */
public class LiftOnConfirmInitialData implements Serializable, IMessageable {
    ...
    public LiftOnConfirmInitialData(){}

    public LiftOnConfirmInitialData(String code, String message) {
