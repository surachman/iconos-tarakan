 ...
 * @author x42jr
 */
public class LoadConfirmInitialData implements Serializable, IMessageable {
    ...
    public LoadConfirmInitialData(){}

    public LoadConfirmInitialData(String code, String message) {
