...
public class RecapUpahBuruhUc implements Serializable, EntityAuditable {
    ...
    public RecapUpahBuruhUc(Integer id, String crane, int weightGroup, String isExportImport, String operation, String activity, int amount, BigDecimal charge, BigDecimal totalCharge, String createdBy, Date createdDate) {
        this.id = id;
        this.crane = crane;
