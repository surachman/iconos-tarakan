...
*/
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentConfirm", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.name, " 
+"  scd.cont_status, " 
...
+"  scd.id, " 
+"  scd.block " 
+"FROM service_cont_transhipment scd, " 
...
*/
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentByPpkbList", query = 
"SELECT r.id, " 
+"  r.commodity_code, " 
+"  r.block, " 
+"  r.cont_type, " 
...
+"  r.bl_no, " 
+"  r.mlo " 
+"FROM service_cont_transhipment r " 
+"WHERE r.position   ='03' " 
+"AND r.new_ppkb     = ? " 
+"AND r.cont_no NOT IN " 
+"  (SELECT cont_no FROM planning_cont_load WHERE no_ppkb=r.new_ppkb " 
+"  )"),
...
*/
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentsConfirm", query = 
"SELECT sct.cont_no, " 
+"  sct.cont_size, " 
...
+"  m_container_type mct " 
+"WHERE sct.cont_type = mct.cont_type " 
+"AND sct.position    ='02' " 
+"AND sct.no_ppkb     = ?"),
...
*/    
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentsSelect", query = 
"SELECT sct.cont_no, " 
+"  sct.v_bay, " 
+"  sct.v_row, " 
+"  sct.v_tier, " 
...
*/
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentsConfirmServed", query = 
"SELECT sct.cont_no, " 
+"  sct.cont_size, " 
+"  mct.type_in_general AS name, " 
+"  sct.cont_status, " 
...
+"WHERE sct.cont_type  = mct.cont_type " 
+"AND sct.position     ='03' " 
+"AND c.commodity_code = sct.commodity_code " 
+"AND sct.no_ppkb      = ?"),
...
*/
    @NamedNativeQuery(name = "ServiceContTranshipment.Native.findServiceContTranshipmentsSelectServed", query = 
"SELECT sct.cont_no, " 
+"  sct.v_bay, " 
+"  sct.v_row, " 
+"  sct.v_tier, " 
...
*/
  @NamedNativeQuery(name = "ServiceContTranshipment.Native.findByIdTranshipment", query = 
"SELECT scd.id " 
+"FROM service_cont_transhipment scd, " 
+"  planning_cont_load pld " 
+"WHERE scd.new_ppkb = pld.no_ppkb " 
+"AND scd.cont_no    =pld.cont_no " 
+"AND scd.new_ppkb   = ? " 
+"AND scd.cont_no    =? " 
+"AND pld.unknown    = 'TRUE'" ),
  })
