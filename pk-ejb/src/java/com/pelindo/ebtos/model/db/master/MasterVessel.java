...
public class MasterVessel implements Serializable, EntityAuditable {
    ...
    private String kapalBayangan = "FALSE";
    ...
    public String getLinerTramper() {
        return linerTramper;
    }

    public void setLinerTramper(String linerTramper) {
    ...
    public String isKapalBayangan() {
        return kapalBayangan;
    }

    public String getKapalBayangan() {
        return kapalBayangan;
    }

    public void setKapalBayangan(String kapalBayangan) {
