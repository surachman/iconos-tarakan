...
*/
    ...
    @NamedNativeQuery(name = "UcDeliveryService.Native.perhitungan", query = 
"SELECT ds.jobslip, " 
+"  us.bl_no, " 
+"  us.weight, " 
+"  m.name, " 
...
/*                                                                            
    @NamedNativeQuery(name = "UcDeliveryService.Native.findByUcDeliveryServiceAutoComplete", query = "SELECT d.jobslip "
                                                                                                    ...
                                                                                                    + "LIMIT 10"),
*/
    @NamedNativeQuery(name = "UcDeliveryService.Native.findByUcDeliveryServiceAutoComplete", query = 
"SELECT jobslip " 
+"FROM " 
+"  (SELECT d.jobslip " 
+"  FROM uc_delivery_service d " 
+"  LEFT JOIN uc_gatedelivery_service s " 
+"  ON d.jobslip     =s.jobslip " 
+"  WHERE s.jobslip IS NULL " 
+"  AND d.jobslip LIKE ('%' " 
+"    || ? " 
+"    ||'%') " 
...
*/    
    @NamedNativeQuery(name = "UcDeliveryService.Native.findByPpkbSusulan", query = 
"SELECT ds.jobslip, " 
+"  us.bl_no, " 
+"  us.unit, " 
+"  us.weight, " 
...
+"  m_commodity c " 
+"WHERE us.no_ppkb                   = us.no_ppkb --? " 
+"AND ds.id_uc                       = us.id_uc " 
+"AND NVL(us.truck_loosing, 'FALSE') = 'FALSE' " 
+"AND c.commodity_code               = us.commodity " 
+"AND us.id_uc NOT                  IN " 
+"  (SELECT id_uc FROM uc_penumpukan_susulan_service WHERE no_ppkb = us.no_ppkb " 
+"  )"),
...
*/    
    @NamedNativeQuery(name = "UcDeliveryService.Native.findByPpkbSusulanByBL", query =     
"SELECT ds.jobslip, " 
+"  us.bl_no, " 
+"  us.unit, " 
+"  us.weight, " 
...
+"AND c.commodity_code       = us.commodity " 
+"AND us.bl_no NOT          IN " 
+"  (SELECT bl_no FROM uc_penumpukan_susulan_service WHERE no_ppkb = us.no_ppkb " 
+"  )"),    
