...
*/    
    @NamedNativeQuery(name = "ServiceDischargeUc.Native.findByPpkb", query = 
"SELECT sdu.id, " 
+"  sdu.no_bl, " 
+"  m.name, " 
+"  sdu.unit, " 
...
+"  sdu.block, " 
+"  sdu.id_equipment " 
+"FROM service_discharge_uc sdu, " 
+"  m_commodity m " 
+"WHERE sdu.no_ppkb      = ? " 
+"AND sdu.commodity_code = m.commodity_code " 
+"AND sdu.position       = '02' " 
+"OR (sdu.position       = '03' " 
+"AND sdu.truck_lossing  = 'TRUE')"),
...
*/
    @NamedNativeQuery(name = "ServiceDischargeUc.Native.findByBlNo", query =   
"SELECT s.id, " 
+"  s.no_ppkb, " 
+"  s.no_bl, " 
+"  c.name, " 
...
+"  s.unit, " 
+"  s.truck_lossing " 
+"FROM service_discharge_uc s, " 
+"  m_commodity c " 
+"WHERE s.commodity_code = c.commodity_code " 
+"AND s.no_ppkb          = ? " 
+"AND s.no_bl            = ? " 
+"AND s.position         = ?")    
})
