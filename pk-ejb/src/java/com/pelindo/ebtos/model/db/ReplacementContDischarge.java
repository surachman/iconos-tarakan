...
public class ReplacementContDischarge implements Serializable, EntityAuditable {
    ...
    public ReplacementContDischarge(Integer id, String commodityCode, int contType, String contNo, short contSize, String contStatus, String createdBy, Date createdDate, String cancelLoading, MasterCustomer mlo) {
        this.id = id;
