...
*/    
    @NamedNativeQuery(name = "DeliveryBarangService.Native.generateId", query = "SELECT MAX(substr(jobslip,7,5))FROM delivery_barang_service WHERE substr(jobslip,3,4) = ?"),
/*    
...
*/    
    @NamedNativeQuery(name = "DeliveryBarangService.Native.findInvoice", query =     
"SELECT ds.job_slip FROM delivery_service ds WHERE ds.cont_no = ? AND ds.no_ppkb = ? AND ds.no_reg = ?"),
