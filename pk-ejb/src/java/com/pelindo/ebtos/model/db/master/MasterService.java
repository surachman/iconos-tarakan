...
@NamedQueries({
    ...
    @NamedQuery(name = "MasterService.findSelectService", query = "SELECT m FROM MasterService m where m.serviceName='RECEIVING'"),    
    @NamedQuery(name = "MasterService.findSelectServiceDelivery", query = "SELECT m FROM MasterService m where m.serviceName='DELIVERY'"),    
    @NamedQuery(name = "MasterService.findSelectServiceDeliveryUC", query = "SELECT m FROM MasterService m where m.serviceName='DELIVERY UC'"),    
    @NamedQuery(name = "MasterService.findSelectServiceUC", query = "SELECT m FROM MasterService m where m.serviceName='RECEIVING UC'"),    
