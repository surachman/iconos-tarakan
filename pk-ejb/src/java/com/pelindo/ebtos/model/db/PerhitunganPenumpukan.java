...
public class PerhitunganPenumpukan implements Serializable, EntityAuditable {
    ...
    @Column(name = "charge_m3", precision = 19, scale = 2)
    private BigDecimal chargeM3 = BigDecimal.ZERO;
    ...
    public BigDecimal getChargeM3() {
        return chargeM3;
    }

    public void setChargeM3(BigDecimal chargeM3) {
        this.chargeM3 = chargeM3;
    }
