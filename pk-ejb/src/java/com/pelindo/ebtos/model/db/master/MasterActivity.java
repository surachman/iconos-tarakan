...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "MasterActivity.Native.translateActivityCode", query = "SELECT trans_to_activity_code("
            + "?, ?, ?, ?, ?,"
            + "?, ?, ?, ?, ?,"
            + "?, ?, ?, ?, ?,"
            + "?, ?, ?, ?, ?,"
            + "?, ?, ?, ?) from dual"),
    @NamedNativeQuery(name="MasterActivity.Native.translateActivityCodeForTarakan", query = "SELECT trans_to_activity_code_tarakan("
            + "?, ?, ?, ?, ?) from dual")
})
