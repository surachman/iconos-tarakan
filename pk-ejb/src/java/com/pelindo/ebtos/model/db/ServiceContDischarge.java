...
@NamedNativeQueries({
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findByNoPpkb", query = 
    "SELECT cont_no, start_placement_date, v_bay, v_row, v_tier, id FROM service_cont_discharge WHERE no_ppkb = ? AND cont_no = ? AND position = ?"),
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findByPpkbAndContNo", query = 
    "SELECT r.id, r.no_ppkb,r.block, r.y_slot, r.y_row, r.y_tier, r.is_seling FROM service_cont_discharge r WHERE r.no_ppkb = ? AND r.cont_no = ?"),
    //@NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesByPpkb", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier FROM service_cont_discharge  p, m_container_type  c WHERE p.cont_type=c.cont_type AND no_ppkb = ? ORDER BY p.id DESC"),
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesByPpkb", query = 
    "SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.exDischargeStocksPerCustomer", query = 
"SELECT scd.cont_no, " 
+"  mc.name, " 
+"  scd.cont_size, " 
+"  scd.cont_status, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.exDischargeStocksPerCustomer_summary", query = 
"SELECT mc.cust_code, " 
+"  COUNT( " 
+"  CASE " 
+"    WHEN scd.cont_status = 'MTY' " 
...
+"GROUP BY mc.cust_code"),                                                                                                
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDeliverableContainersByPpkb", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier,kapal.no_ppkb,kapal.name,kapal.voy_in,kapal.voy_out "
                                                                                                    + "FROM service_cont_discharge  p "
                                                                                                            + "JOIN m_container_type  c ON (p.cont_type=c.cont_type) "
...
+ "WHERE p.status IN ('Approved', 'Servicing', 'ReadyService', 'Served') ) kapal on ds.no_ppkb=kapal.no_ppkb "                      
                                                                                                    + "WHERE p.no_ppkb = ? AND i.payment_status = 'PAYMENT' AND p.is_delivery = FALSE AND p.position = '" + ServiceContDischarge.LOCATION_CY + "' "
                                                                                                    + "ORDER BY p.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDeliverableContainersByPpkb", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"ON (ds.cont_no=p.cont_no " 
+"AND ds.no_ppkb=p.no_ppkb) " 
+"JOIN invoice i " 
+"ON (ds.no_reg = i.no_reg) " 
+"JOIN service_gate_delivery sgd " 
+"ON (sgd.cont_no=p.cont_no " 
+"AND sgd.no_ppkb=p.no_ppkb) " 
+"JOIN " 
+"  (SELECT p.no_ppkb, " 
+"    mv.name, " 
+"    pp.voy_in, " 
...
+"  ) kapal ON ds.no_ppkb=kapal.no_ppkb " 
+"WHERE p.no_ppkb        = ? " 
...
/*
@NamedNativeQuery(name = "ServiceContDischarge.Native.findDeliverableContainersByPpkb2", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier,kapal.no_ppkb,kapal.name,kapal.voy_in,kapal.voy_out "
                                                                                                    + "FROM service_cont_discharge  p "
                                                                                                            + "JOIN m_container_type  c ON (p.cont_type=c.cont_type) "
                                                                                                            + "JOIN delivery_service ds ON (ds.cont_no=p.cont_no AND ds.no_ppkb=p.no_ppkb) "
                                                                                                                    + "JOIN invoice i ON (ds.no_reg = i.no_reg) "
...
+ "JOIN m_vessel mv ON (pp.vessel_code = mv.vessel_code)  "
+ "WHERE p.status IN ('Approved', 'Servicing', 'ReadyService', 'Served') ) kapal on ds.no_ppkb=kapal.no_ppkb "                      
                                                                                                    + "WHERE i.payment_status = 'PAYMENT' AND p.is_delivery = FALSE AND p.position = '" + ServiceContDischarge.LOCATION_CY + "' "
                                                                                                    + "ORDER BY p.id DESC"),
*/
@NamedNativeQuery(name = "ServiceContDischarge.Native.findDeliverableContainersByPpkb2", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"AND p.position         = '" + ServiceContDischarge.LOCATION_CY + "' " 
+"ORDER BY p.id DESC"),                                                                                                    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesForRekapDischarge", query = "SELECT p.id, p.cont_no FROM service_cont_discharge  WHERE p.position = '" + ServiceContDischarge.LOCATION_CY + "' AND no_ppkb = ? ORDER BY p.id DESC"),
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesByPpkbDeliveryTrue", query = "SELECT p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier, p.position FROM service_cont_discharge  p, m_container_type  c WHERE p.cont_type=c.cont_type AND p.is_delivery = 'TRUE' AND no_ppkb = ? ORDER BY p.id DESC"),
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesConfirm", query = "SELECT scd.cont_no, scd.cont_size, mct.type_in_general  name, scd.cont_status, scd.cont_gross, scd.seal_no, scd.v_bay, scd.v_row, scd.v_tier, scd.id, scd.position = '" + ServiceContDischarge.LOCATION_HT + "' deletable "
                                                                                                    + "FROM service_cont_discharge  scd "
                                                                                                            + "JOIN m_container_type  mct ON (scd.cont_type = mct.cont_type) "
                                                                                                    + "WHERE scd.position NOT IN ('" + ServiceContDischarge.LOCATION_VESSEL + "') AND scd.no_ppkb = ? "
                                                                                                    + "ORDER BY scd.modified_date ASC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesConfirm", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.type_in_general  name, " 
+"  scd.cont_status, " 
+"  scd.cont_gross, " 
+"  scd.seal_no, " 
+"  scd.v_bay, " 
...
+"  scd.id, " 
+"  CASE " 
+"    WHEN scd.position = '" + ServiceContDischarge.LOCATION_HT +"' " 
+"    THEN 'TRUE' " 
+"    ELSE 'FALSE' " 
+"  END deletable " 
+"FROM service_cont_discharge scd " 
+"JOIN m_container_type mct " 
+"ON (scd.cont_type       = mct.cont_type) " 
+"WHERE scd.position NOT IN ('" + ServiceContDischarge.LOCATION_VESSEL + "') " 
+"AND scd.no_ppkb         = ? " 
+"ORDER BY scd.modified_date ASC"),        
/*                                                                                            
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesSelect", query = 
"SELECT scd.cont_no, " 
+"  scd.v_bay, " 
+"  scd.v_row, " 
+"  scd.v_tier, " 
...
+"ON (scd.cont_no=sgd.cont_no " 
+"AND scd.no_ppkb=sgd.no_ppkb) " 
+"JOIN m_commodity mc " 
+"ON (scd.commodity_code     =mc.commodity_code) " 
+"WHERE scd.position         = '" + ServiceContDischarge.LOCATION_VESSEL + "' " 
+"AND ((mc.dangerous_class  IS NULL " 
+"OR mc.dangerous_class NOT IN ('1', '7')) " 
+"OR (mc.dangerous_class    IN ('1', '7') " 
+"AND sgd.cont_no           IS NOT NULL)) " 
+"AND scd.no_ppkb            = ? " 
+"ORDER BY scd.id DESC"),                                                                                                    
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargableContainer", query = "SELECT scd.cont_no, scd.v_bay, scd.v_row, scd.v_tier, scd.id "
                                                                                                    ...
                                                                                                    + "ORDER BY scd.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargableContainer", query = 
"SELECT scd.cont_no, " 
+"  scd.v_bay, " 
+"  scd.v_row, " 
+"  scd.v_tier, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDeliverableCont", query = 
"SELECT scd.id, " 
+"  scd.cont_no, " 
+"  scd.no_ppkb, " 
+"  scd.y_slot, " 
...
+"  mcd.name condition, " 
+"  CASE " 
+"    WHEN sgd.job_slip IS NOT NULL " 
+"    THEN 'TRUE' " 
+"    ELSE 'FALSE' " 
+"  END has_entering_gate " 
+"FROM ((service_cont_discharge scd " 
+"JOIN (delivery_service ds " 
+"JOIN invoice i " 
+"ON (ds.no_reg = i.no_reg) " 
+"LEFT JOIN service_gate_delivery sgd " 
+"ON (ds.job_slip = sgd.job_slip)) " 
+"ON (ds.cont_no  =scd.cont_no " 
+"AND ds.no_ppkb  =scd.no_ppkb)) " 
+"LEFT JOIN m_cont_damage mcd " 
+"ON (scd.cont_damage=mcd.id)) " 
+"JOIN planning_vessel pv " 
+"ON (pv.no_ppkb=scd.no_ppkb) " 
+"JOIN m_vessel mv " 
+"ON (pv.vessel_code   =mv.vessel_code) " 
+"WHERE scd.cont_no    = ? " 
+"AND scd.position     = '" + ServiceContDischarge.LOCATION_CY + "' " 
+"AND scd.is_delivery  = 'FALSE' " 
+"AND i.payment_status = 'PAYMENT'"),
/*                                                                                        
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesConfirmServiced", query = "SELECT scd.cont_no, scd.cont_size, mct.type_in_general  name, scd.cont_status, scd.cont_gross, scd.seal_no, scd.block, scd.y_slot, scd.y_row, scd.y_tier, scd.id, false  topTier, scd.position = '" + ServiceContDischarge.LOCATION_CY + "' AND is_delivery = FALSE deletable "
                                                                                                            + "FROM service_cont_discharge  scd "
                                                                                                                    + "JOIN m_container_type  mct ON (scd.cont_type = mct.cont_type) "
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesConfirmServiced", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.type_in_general name, " 
+"  scd.cont_status, " 
...
+"  'FALSE' topTier, " 
+"  CASE " 
+"    WHEN scd.position = '" + ServiceContDischarge.LOCATION_CY + "' " 
...
+"JOIN m_container_type mct " 
+"ON (scd.cont_type       = mct.cont_type) " 
+"WHERE scd.position NOT IN ('" + ServiceContDischarge.LOCATION_VESSEL + "', '" + ServiceContDischarge.LOCATION_HT + "') " 
+"AND scd.no_ppkb         = ? " 
+"ORDER BY scd.modified_date DESC"),                                                                                                            
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesSelectServiced", query = "SELECT scd.cont_no, scd.v_bay, scd.v_row, scd.v_tier, scd.id FROM service_cont_discharge  scd WHERE scd.position='" + ServiceContDischarge.LOCATION_HT + "' AND scd.no_ppkb = ? ORDER BY scd.modified_date ASC"),
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerReefer", query = 
"SELECT scd.cont_type, " 
+"  scd.cont_no, " 
+"  scd.cont_size, " 
+"  scd.cont_status, " 
+"  scd.no_ppkb " 
...
+"ON (sr.no_ppkb            = scd.no_ppkb " 
+"AND sr.cont_no            = scd.cont_no) " 
+"WHERE mct.type_in_general = 'RFR' " 
+"AND scd.cont_no           = ? " 
+"AND sr.cont_no           IS NULL " 
+"AND scd.position          = '" + ServiceContDischarge.LOCATION_CY + "'"),
...
/*                                                                                        
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesDeliveryService", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier,p.bl_no, p.is_import "
                                                                                                            ...
                                                                                                            + "ORDER BY p.id DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesDeliveryService", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"ON (p.cont_type=c.cont_type) " 
+"JOIN m_commodity mc " 
+"ON (p.commodity_code=mc.commodity_code) " 
+"LEFT JOIN delivery_service ds " 
+"ON (ds.no_ppkb                                                                   = p.no_ppkb " 
+"AND ds.cont_no                                                                   = p.cont_no) " 
+"WHERE p.no_ppkb                                                                  = ? " 
+"AND ds.cont_no                                                                  IS NULL " 
+"AND p.is_delivery                                                                = 'FALSE' " 
+"AND (p.position                                                                  = '" + ServiceContDischarge.LOCATION_CY + "' " 
+"OR (p.position                                                                   = '" + ServiceContDischarge.LOCATION_VESSEL + "' " 
+"AND c.type_in_general                                                            = 'RFR' " 
+"AND (SELECT value_string FROM m_setting_app WHERE id = 'ebtos.validation.level') = 'MEDIUM') " 
+"OR (p.position                                                                   = '" + ServiceContDischarge.LOCATION_VESSEL + "' " 
+"AND (SELECT value_string FROM m_setting_app WHERE id = 'ebtos.validation.level') = 'LOW') " 
+"OR (p.position                                                                   = '" + ServiceContDischarge.LOCATION_VESSEL + "' " 
+"AND (mc.dangerous_class                                                          = '1' " 
+"OR mc.dangerous_class                                                            = '7')) ) " 
+"ORDER BY p.id DESC"),              
/*                                                                                              
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesAngsurService", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier,p.bl_no FROM service_cont_discharge  p, m_container_type  c WHERE p.cont_type=c.cont_type AND p.is_delivery = 'FALSE' AND p.position = '" + ServiceContDischarge.LOCATION_CY + "' AND no_ppkb = ? AND p.cont_no NOT IN (SELECT cont_no FROM angsur_service WHERE no_ppkb = p.no_ppkb) ORDER BY p.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesAngsurService", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"AND p.position     = '" + ServiceContDischarge.LOCATION_CY + "' " 
+"AND no_ppkb        = ? " 
+"AND p.cont_no NOT IN " 
+"  (SELECT cont_no FROM angsur_service WHERE no_ppkb = p.no_ppkb " 
+"  ) " 
+"ORDER BY p.id DESC"),
/*    
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStrippingService", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"AND p.is_delivery   = 'FALSE' " 
+"AND p.is_behandle   = 'FALSE' " 
+"AND p.is_cfs        = 'FALSE' " 
+"AND p.is_inspection = 'FALSE' " 
+"AND p.no_ppkb       = ?"),

/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStuffingService", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, com.name, p.over_size, p.dangerous, p.dg_label,p.bl_no, p.mlo FROM service_cont_discharge  p, m_container_type  c, m_commodity  com WHERE p.commodity_code = com.commodity_code AND p.cont_status = 'MTY' AND p.cont_type=c.cont_type AND p.is_delivery = 'FALSE' AND p.no_ppkb = ? AND p.cont_no NOT IN (SELECT cont_no FROM stuffing_service WHERE no_ppkb = p.no_ppkb) ORDER BY p.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStuffingService", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"  m_container_type c, " 
+"  m_commodity com " 
+"WHERE p.commodity_code = com.commodity_code " 
+"AND p.cont_status      = 'MTY' " 
+"AND p.cont_type        =c.cont_type " 
+"AND p.is_delivery      = 'FALSE' " 
+"AND p.no_ppkb          = ? " 
+"AND p.cont_no NOT     IN " 
+"  (SELECT cont_no FROM stuffing_service WHERE no_ppkb = p.no_ppkb " 
+"  ) " 
+"ORDER BY p.id DESC"),
...
/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesBehandleService", query = "SELECT p.cont_no, p.cont_size, c.type_in_general, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier "
                                                                                                            ...
                                                                                                            + "ORDER BY p.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesBehandleService", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general, " 
+"  p.cont_status, " 
...
+"JOIN m_container_type c " 
+"ON (p.cont_type=c.cont_type) " 
+"LEFT JOIN behandle_service bs " 
+"ON (p.cont_no       =bs.cont_no " 
+"AND p.no_ppkb       =bs.no_ppkb) " 
+"WHERE bs.cont_no   IS NULL " 
+"AND p.is_delivery   = 'FALSE' " 
+"AND p.is_behandle   = 'FALSE' " 
+"AND p.is_cfs        = 'FALSE' " 
+"AND p.is_inspection = 'FALSE' " 
...
/*                                                                                                       
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findConvertableToLoadContainers", query = "SELECT p.cont_no, p.cont_size, c.type_in_general, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier "
                                                                                                            ...
                                                                                                            + "ORDER BY p.id DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findConvertableToLoadContainers", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general, " 
+"  p.cont_status, " 
...
+"JOIN m_container_type c " 
+"ON (p.cont_type=c.cont_type) " 
+"LEFT JOIN discharge_to_load_service dtl " 
+"ON (dtl.service_cont_discharge_id=p.id) " 
+"LEFT JOIN delivery_service ds " 
+"ON (ds.cont_no=p.cont_no " 
+"AND ds.no_ppkb=p.no_ppkb) " 
+"LEFT JOIN behandle_service bs " 
+"ON (bs.cont_no      =p.cont_no " 
+"AND bs.no_ppkb      =p.no_ppkb) " 
+"WHERE dtl.job_slip IS NULL " 
+"AND ds.cont_no     IS NULL " 
+"AND bs.cont_no     IS NULL " 
+"AND p.is_delivery   = 'FALSE' " 
+"AND p.is_behandle   = 'FALSE' " 
+"AND p.is_cfs        = 'FALSE' " 
+"AND p.is_inspection = 'FALSE' " 
...
+"  p.is_inspection, " 
+"  CASE " 
+"    WHEN is_behandle  <> 'TRUE' " 
+"    AND is_cfs        <> 'TRUE' " 
+"    AND is_inspection <> 'TRUE' " 
+"    THEN 'TRUE' " 
+"    ELSE 'FALSE' " 
+"  END is_cy " 
+"FROM service_cont_discharge p, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesMovementInspection", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesByContAndPpkb", query = "SELECT p.id,p.no_ppkb,p.block,p.y_slot,p.y_row,p.y_tier FROM service_cont_discharge  p WHERE p.is_delivery = 'FALSE' AND p.no_ppkb=? AND p.cont_no=? "),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesByContAndPpkb", query = 
"SELECT p.id, " 
+"  p.no_ppkb, " 
+"  p.block, " 
+"  p.y_slot, " 
...
+"  p.y_tier " 
+"FROM service_cont_discharge p " 
+"WHERE p.is_delivery = 'FALSE' " 
+"AND p.no_ppkb       =? " 
+"AND p.cont_no       =?" ),
/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB", query = "SELECT p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, change(p.over_size), change(p.dangerous), change(p.dg_label), e1.equip_code, e1.start_time, e1.end_time, e2.equip_code, e2.start_time, e2.end_time, e3.equip_code, e3.start_time, e3.end_time, p.block, p.start_placement_date, mc.name "
                                                                                                + "FROM "
...
*/         
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
+"  p.cont_status, " 
+"  p.cont_gross, " 
+"  change(p.over_size), " 
+"  change(p.dangerous), " 
...
+"LEFT JOIN delivery_service ds " 
+"ON (p.cont_no=ds.cont_no " 
+"AND p.no_ppkb=ds.no_ppkb) " 
+"LEFT JOIN registration r " 
+"ON (ds.no_reg=r.no_reg) " 
...
+"AND p.position  = ?"),
    ...
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKBAll", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
+"  p.cont_status, " 
...
/*
       @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB1", query = "SELECT p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, change(p.over_size), change(p.dangerous), change(p.dg_label), e1.equip_code, e1.start_time, e1.end_time, e2.equip_code, e2.start_time, e2.end_time, e3.equip_code, e3.start_time, e3.end_time, p.block, p.start_placement_date, mc.name "
                                                                                                + "FROM "
                                                                                                        + "service_cont_discharge p "
                                                                                                                + "LEFT JOIN m_container_type c ON p.cont_type=c.cont_type "
                                                                                                                + "LEFT JOIN equipment e1 ON p.cont_no = e1.cont_no AND p.no_ppkb = e1.no_ppkb AND e1.operation = 'DISCHARGE' AND e1.equipment_act_code = 'STEVEDORING' "
...
*/
       @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB1", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
+"  p.cont_status, " 
...
+"AND p.is_delivery = ?"),     
/*                                                                                           
        @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB2", query = "SELECT p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, change(p.over_size), change(p.dangerous), change(p.dg_label), e1.equip_code, e1.start_time, e1.end_time, e2.equip_code, e2.start_time, e2.end_time, e3.equip_code, e3.start_time, e3.end_time, p.block, p.start_placement_date, mc.name "
                                                                                                + "FROM "
                                                                                                        + "service_cont_discharge p "
                                                                                                                + "LEFT JOIN m_container_type c ON p.cont_type=c.cont_type "
                                                                                                                + "LEFT JOIN equipment e1 ON p.cont_no = e1.cont_no AND p.no_ppkb = e1.no_ppkb AND e1.operation = 'DISCHARGE' AND e1.equipment_act_code = 'STEVEDORING' "
...
*/
        @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKB2", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
+"  p.cont_status, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKBFront", query = "SELECT p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, change(p.over_size), change(p.dangerous), change(p.dg_label), e1.equip_code, e1.start_time, e1.end_time, e2.equip_code, e2.start_time, e2.end_time, e3.equip_code, e3.start_time, e3.end_time, p.block, p.start_placement_date, mc.name "
                                                                                                + "FROM "
                                                                                                        + "service_cont_discharge p "
                                                                                                                + "LEFT JOIN m_container_type c ON p.cont_type=c.cont_type "
                                                                                                                + "LEFT JOIN equipment e1 ON p.cont_no = e1.cont_no AND p.no_ppkb = e1.no_ppkb AND e1.operation = 'DISCHARGE' AND e1.equipment_act_code = 'STEVEDORING' "
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findDischargeMonitoringByPPKBFront", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
+"  p.cont_status, " 
...
+"ON (r.cust_code     =mc.cust_code) " 
+"WHERE p.no_ppkb     = ? " 
+"AND p.position NOT IN ('01','02')"),

/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findUcDischargeMonitoringByPPKB", query = "SELECT uc.bl_no, mc.name, uc.unit, uc.weight, uc.cubication  vol, uc.truck_loosing, e1.equip_code  cc_code, e1.start_time  start_stv, e1.end_time  end_stv, e2.equip_code  ht_code, e2.start_time  start_ht, e2.end_time  end_ht, e3.equip_code  tt_code, e3.start_time  start_tt, e3.end_time  end_tt "
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findUcDischargeMonitoringByPPKB", query = 
"SELECT uc.bl_no, " 
+"  mc.name, " 
+"  uc.unit, " 
+"  uc.weight, " 
+"  uc.cubication vol, " 
+"  uc.truck_loosing, " 
+"  e1.equip_code cc_code, " 
+"  e1.start_time start_stv, " 
+"  e1.end_time end_stv, " 
+"  e2.equip_code ht_code, " 
+"  e2.start_time start_ht, " 
+"  e2.end_time end_ht, " 
+"  e3.equip_code tt_code, " 
+"  e3.start_time start_tt, " 
+"  e3.end_time end_tt " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findByContNoMov", query = 
"SELECT cont_no, " 
+"  start_placement_date, " 
+"  v_bay, " 
+"  v_row, " 
+"  v_tier, " 
+"  id, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findReeferDischargeService", query = "SELECT scd.cont_no, scd.cont_size, mct.name, scd.cont_status, scd.cont_gross, scd.seal_no, scd.id, scd.bl_no, COALESCE(MAX(rds.valid_date), sr.plug_on) plug_on, MAX(sr.plug_off) plug_off  "
                                                                                                ...
                                                                                                + "ORDER BY scd.id DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findReeferDischargeService", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.name, " 
+"  scd.cont_status, " 
...
+"  scd.id, " 
+"  scd.bl_no, " 
+"  COALESCE(MAX(rds.valid_date), sr.plug_on) plug_on, " 
+"  MAX(sr.plug_off) plug_off " 
+"FROM service_cont_discharge scd " 
+"JOIN service_reefer sr " 
+"ON (scd.no_ppkb = sr.no_ppkb " 
+"AND scd.cont_no = sr.cont_no) " 
+"JOIN m_container_type mct " 
+"ON (scd.cont_type = mct.cont_type) " 
+"LEFT JOIN reefer_discharge_service rds " 
+"ON (scd.no_ppkb = rds.no_ppkb " 
+"AND scd.cont_no = rds.cont_no) " 
+"LEFT JOIN " 
+"  (SELECT rds.cont_no, " 
+"    rds.no_ppkb, " 
+"    rds.no_reg " 
+"  FROM reefer_discharge_service rds " 
+"  JOIN registration r " 
+"  ON (rds.no_reg          =r.no_reg ) " 
+"  WHERE r.status_service IN ('registrasi','confirm') " 
+"  ) rds2 ON (rds.no_ppkb  = rds2.no_ppkb " 
+"AND rds.cont_no           = rds2.cont_no) " 
+"WHERE scd.no_ppkb         = ? " 
+"AND scd.position NOT     IN ('01', '02') " 
+"AND sr.plug_on           IS NOT NULL " 
+"AND (sr.plug_off         IS NULL " 
+"OR sr.plug_off            > rds.valid_date) " 
+"AND rds2.cont_no         IS NULL " 
+"GROUP BY scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.name, " 
+"  scd.cont_status, " 
+"  scd.cont_gross, " 
...
/*                                                                                                
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findHandlingDischargeMonitoring", query = "SELECT p.cont_type, p.cont_no, p.cont_status, p.cont_size, c.type_in_general  name, e1.equip_code, e1.start_time, e1.end_time, e2.equip_code, e2.start_time, e2.end_time, e3.equip_code, e3.start_time, e3.end_time, p.seal_no "
    ...
    + "WHERE p.no_ppkb = ?"),
*/    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findHandlingDischargeMonitoring", query = 
"SELECT p.cont_type, " 
+"  p.cont_no, " 
+"  p.cont_status, " 
+"  p.cont_size, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findRecapPenumpukan", query = "SELECT scd.id, scd.cont_no, scd.cont_type, scd.cont_size, scd.cont_status, scd.cont_gross, CASE WHEN scd.over_size=true THEN 'Yes' WHEN scd.over_size=false THEN 'No' END  over_size, rp.charge_masa_1, rp.jasa_dermaga, rp.total_charge, curr.symbol, curr.language, curr.country,mt.type_in_general  name FROM service_cont_discharge scd, recap_penumpukan rp, m_currency curr ,m_container_type mt WHERE scd.cont_no = rp.cont_no AND scd.no_ppkb = rp.no_ppkb AND rp.curr_code = curr.curr_code AND mt.cont_type=scd.cont_type AND scd.no_ppkb = ?"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findRecapPenumpukan", query = 
"SELECT scd.id, " 
+"  scd.cont_no, " 
+"  scd.cont_type, " 
+"  scd.cont_size, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findByContNo", query = "SELECT cont_no, start_placement_date, v_bay, v_row, v_tier, id, y_slot, y_row, y_tier, block, no_ppkb, cont_size, 's'  origin FROM service_cont_discharge WHERE cont_no = ? AND position = ?"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findByContNo", query = 
"SELECT cont_no, " 
+"  start_placement_date, " 
+"  v_bay, " 
+"  v_row, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargeByPpkbAndContNoFront", query = 
"SELECT r.id, " 
+"  r.no_ppkb, " 
+"  r.cont_no, " 
+"  r.cont_size, " 
...
/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesDeliveryServiceByBL", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, p.block, p.y_slot, p.y_row, p.y_tier, p.id, p.seal_no, p.v_bay, p.v_row, p.v_tier,p.bl_no, p.is_import "
                                                                                                            ...
                                                                                                            + "ORDER BY p.id DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesDeliveryServiceByBL", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStrippingServiceByBL", query =
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
+"AND no_ppkb         = ? " 
+"AND p.cont_no NOT  IN " 
+"  (SELECT cont_no FROM stripping_service WHERE no_ppkb = p.no_ppkb " 
+"  ) " 
+"ORDER BY p.id DESC"),    

/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStuffingServiceByBL", query = "SELECT p.cont_no, p.cont_size, c.name, p.cont_status, p.cont_gross, com.name, p.over_size, p.dangerous, p.dg_label,p.bl_no,p.mlo FROM service_cont_discharge  p, m_container_type  c, m_commodity  com WHERE p.commodity_code = com.commodity_code AND p.cont_status = 'MTY' AND p.cont_type=c.cont_type AND p.is_delivery = '"FALSE"' AND p.bl_no = ? AND p.no_ppkb = ? AND p.cont_no NOT IN (SELECT cont_no FROM stuffing_service WHERE no_ppkb = p.no_ppkb) ORDER BY p.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargesStuffingServiceByBL", query = 
"SELECT p.cont_no, " 
+"  p.cont_size, " 
+"  c.name, " 
+"  p.cont_status, " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findReeferDischargeServiceByBL", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.name, " 
+"  scd.cont_status, " 
...
*/
    @NamedNativeQuery(name="ServiceContDischarge.Native.findServiceContDischargeUnplacement", query= 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  scd.cont_status, " 
+"  scd.v_bay, " 
...
/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContMovementMobile", query = "SELECT id, cont_no, no_ppkb, y_slot, y_row, y_tier, block, is_behandle, is_cfs, is_inspection, 'discharge'  asal FROM service_cont_discharge WHERE cont_no = ? AND position = ? AND is_delivery = ?"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContMovementMobile", query = 
"SELECT id, " 
+"  cont_no, " 
+"  no_ppkb, " 
+"  y_slot, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetails", query = "SELECT scd.cont_no, scd.cont_size, mct.type_in_general  name, scd.cont_status, mc.name, scd.cont_gross, scd.gross_class, scd.seal_no, change(scd.over_size), change(scd.dangerous), change(scd.dg_label), scd.id, scd.no_ppkb, scd.bl_no, scd.position "
                                                                                        + "FROM service_cont_discharge scd "
                                                                                                + "JOIN m_container_type mct ON (scd.cont_type = mct.cont_type) "
                                                                                                + "JOIN m_commodity mc ON (scd.commodity_code =  mc.commodity_code) "
                                                                                        ...
                                                                                        + "ORDER BY scd.modified_date DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetails", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.type_in_general name, " 
+"  scd.cont_status, " 
...
+"  scd.gross_class, " 
+"  scd.seal_no, " 
+"  change(scd.over_size), " 
+"  change(scd.dangerous), " 
+"  change(scd.dg_label), " 
+"  scd.id, " 
+"  scd.no_ppkb, " 
+"  scd.bl_no, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetailsPPKBnull", query = "SELECT scd.cont_no, scd.cont_size, mct.type_in_general  name, scd.cont_status, mc.name, scd.cont_gross, scd.gross_class, scd.seal_no, change(scd.over_size), change(scd.dangerous), change(scd.dg_label), scd.id, scd.no_ppkb, scd.bl_no, scd.position "
                                                                                        + "FROM service_cont_discharge scd "
                                                                                                + "JOIN m_container_type mct ON (scd.cont_type = mct.cont_type) "
                                                                                                + "JOIN m_commodity mc ON (scd.commodity_code =  mc.commodity_code) "
                                                                                        + "WHERE scd.cont_no = ? "
                                                                                        + "ORDER BY scd.modified_date DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetailsPPKBnull", query =
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.type_in_general name, " 
+"  scd.cont_status, " 
...
/*
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetailsCONTnull", query = "SELECT scd.cont_no, scd.cont_size, mct.type_in_general  name, scd.cont_status, mc.name, scd.cont_gross, scd.gross_class, scd.seal_no, change(scd.over_size), change(scd.dangerous), change(scd.dg_label), scd.id, scd.no_ppkb, scd.bl_no, scd.position "
                                                                                        + "FROM service_cont_discharge scd "
                                                                                                + "JOIN m_container_type mct ON (scd.cont_type = mct.cont_type) "
                                                                                                + "JOIN m_commodity mc ON (scd.commodity_code =  mc.commodity_code) "
                                                                                        + "WHERE scd.no_ppkb = ? "
                                                                                        + "ORDER BY scd.modified_date DESC;"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerDetailsCONTnull", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.type_in_general name, " 
+"  scd.cont_status, " 
...
/* Needs to Examine where these query is used in App, - MKR, Wed 12 Nov 2014 07:44:47 AM WIT  */
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContIds", query = "select * from xmltable( '/ROWSET/ROW' passing xmltype.createxml (find_contid(?,?,?)) columns find_contid path 'FIND_CONTID')"),
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findPKs", query = "select * from xmltable( '/ROWSET/ROW' passing xmltype.createxml (find_pk(?,?,?,?)) columns FIND_PK path 'FIND_PK')"),
/* Needs to Examine where these query is used in App - MKR, Wed 12 Nov 2014 07:44:47 AM WIT  */

/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceCondischargeToLoads", query = "SELECT scd.id,scd.bl_no,scd.cont_no,mct.name,scd.cont_gross,mc.name,scd.seal_no, scd.cont_size,scd.cont_status,mp.name,mp1.name,scd.block, scd.y_slot, scd.y_row, scd.y_tier FROM service_cont_discharge  scd, m_container_type  mct,m_commodity  mc,m_port mp,m_port mp1 WHERE scd.cont_type = mct.cont_type AND scd.position='" + ServiceContDischarge.LOCATION_CY + "' AND scd.commodity_code=mc.commodity_code AND scd.load_port=mp.port_code AND scd.disch_port=mp1.port_code AND scd.is_delivery = "FALSE" AND scd.no_ppkb=? AND scd.cont_no NOT IN (select cont_no from service_receiving where no_ppkb=scd.no_ppkb) ORDER BY scd.id DESC"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceCondischargeToLoads", query = 
"SELECT scd.id, " 
+"  scd.bl_no, " 
+"  scd.cont_no, " 
+"  mct.name, " 
...
+"AND scd.load_port     =mp.port_code " 
+"AND scd.disch_port    =mp1.port_code " 
+"AND scd.is_delivery   = 'FALSE' " 
+"AND scd.no_ppkb       =? " 
+"AND scd.cont_no NOT  IN " 
+"  (SELECT cont_no FROM service_receiving WHERE no_ppkb=scd.no_ppkb " 
+"  ) " 
+"ORDER BY scd.id DESC"),

/*    
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceCondischargeMonitoringContDisch", query = "SELECT p.bl_no,p.cont_no, p.cont_size, c.type_in_general  name, p.cont_status, p.cont_gross, com.name,p.start_placement_date,ds.masa_1,ds.masa_2,p.position FROM (service_cont_discharge  p LEFT JOIN delivery_service ds ON p.no_ppkb=ds.no_ppkb AND p.cont_no=ds.cont_no), m_container_type c, m_commodity  com WHERE p.commodity_code = com.commodity_code AND p.cont_type=c.cont_type AND p.no_ppkb = ?"),
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceCondischargeMonitoringContDisch", query = 
"SELECT p.bl_no, " 
+"  p.cont_no, " 
+"  p.cont_size, " 
+"  c.type_in_general name, " 
...
+"FROM (service_cont_discharge p " 
+"LEFT JOIN delivery_service ds " 
+"ON p.no_ppkb =ds.no_ppkb " 
+"AND p.cont_no=ds.cont_no), " 
+"  m_container_type c, " 
+"  m_commodity com " 
+"WHERE p.commodity_code = com.commodity_code " 
+"AND p.cont_type        =c.cont_type " 
...
/*
    ...
    + "FROM service_cont_discharge  scd, m_container_type  mct "
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findContainerThatHasConfirmed", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  mct.name, " 
+"  scd.cont_status, " 
...
/*    
    ...
    + "WHERE scd.cont_type = mct.cont_type)  tipe,  scd.cont_status,  "
    + "(SELECT mgc.description FROM m_gross_class mgc WHERE scd.gross_class::TEXT = mgc.gross_class::TEXT)  gross_class, "
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findServiceContDischargeByPPKBAndBlock", query = 
"SELECT scd.cont_no, " 
+"  scd.cont_size, " 
+"  (SELECT mct.type_in_general " 
+"  FROM m_container_type mct " 
+"  WHERE scd.cont_type = mct.cont_type " 
+"  ) tipe, " 
+"  scd.cont_status, " 
+"  (SELECT mgc.description " 
+"  FROM m_gross_class mgc " 
+"  WHERE scd.gross_class = mgc.gross_class " 
+"  ) gross_class, " 
+"  scd.dangerous, " 
+"  scd.over_size, " 
+"  scd.is_import, " 
...
+"  e3.start_time, " 
+"  e3.end_time, " 
+"  m1.name asalPelabuhan, " 
+"  m2.name tujuanPelabuhan, " 
+"  mv.name, " 
+"  p.no_ppkb, " 
+"  ps.voy_in, " 
+"  ps.voy_out " 
...
+"AND e3.operation          = 'DISCHARGE' " 
+"AND e3.equipment_act_code = 'LIFTOFF') " 
+"WHERE p.cont_no LIKE ('%' " 
+"  || ? " 
+"  ||'%') " 
+"AND m1.port_code   =p.load_port " 
+"AND m2.port_code   =p.disch_port " 
...
*/
    @NamedNativeQuery(name = "ServiceContDischarge.Native.findSearchingContainerTrackingDischargeFront", query = 
"SELECT r.id, " 
+"  r.no_ppkb, " 
+"  r.bl_no, " 
+"  r.cont_no, " 
...
public class ServiceContDischarge implements Serializable, EntityAuditable {
    ...
    private String exStripping = "FALSE";
    ...
    private String cancelLoading = "FALSE";
    ...
    private String dischargeToLoad = "FALSE";
    ...
    public String getCancelLoading() {
        return cancelLoading;
    }

    public void setCancelLoading(String cancelLoading) {
    ...
    public String isDischargeToLoad() {
        return dischargeToLoad;
    }

    public void setDischargeToLoad(String dischargeToLoad) {
