...
@Table(name = "recap_other_package")
@NamedQueries({
    @NamedQuery(name = "RecapOtherPackage.findAll", query = "SELECT r FROM RecapOtherPackage r"),
    @NamedQuery(name = "RecapOtherPackage.findById", query = "SELECT r FROM RecapOtherPackage r WHERE r.id = :id"),
    @NamedQuery(name = "RecapOtherPackage.findByNoPpkb", query = "SELECT r FROM RecapOtherPackage r WHERE r.noPpkb = :noPpkb"),
    @NamedQuery(name = "RecapOtherPackage.deleteByNoPpkb", query = "DELETE FROM RecapOtherPackage r WHERE r.noPpkb = :noPpkb"),
    @NamedQuery(name = "RecapOtherPackage.findByActivityCode", query = "SELECT r FROM RecapOtherPackage r WHERE r.activityCode = :activityCode"),
    @NamedQuery(name = "RecapOtherPackage.findByAmount", query = "SELECT r FROM RecapOtherPackage r WHERE r.amount = :amount"),
    @NamedQuery(name = "RecapOtherPackage.findByCharge", query = "SELECT r FROM RecapOtherPackage r WHERE r.charge = :charge"),
    @NamedQuery(name = "RecapOtherPackage.findByTotalCharge", query = "SELECT r FROM RecapOtherPackage r WHERE r.totalCharge = :totalCharge"),
    @NamedQuery(name = "RecapOtherPackage.findByActivityCodeAndNoPpkb", query = "SELECT r FROM RecapOtherPackage r WHERE r.activityCode = :activityCode AND r.noPpkb = :noPpkb"),
    @NamedQuery(name = "RecapOtherPackage.findByBentuk3Constraint", query = "SELECT r FROM RecapOtherPackage r WHERE r.contStatus = :contStatus AND r.crane = :crane AND r.isExportImport = :isExportImport AND r.sling = :sling AND r.containerType.id = :containerType AND r.activityCode = :activityCode AND r.noPpkb = :noPpkb AND r.currCode = :currCode AND r.openDoor = :openDoor AND r.contSize = :contSize AND r.twentyOneFeet = :twentyOneFeet AND r.charge = :charge")})
@NamedNativeQueries({
    @NamedNativeQuery(name = "RecapOtherPackage.Native.findByActCode", query = "SELECT id FROM recap_handling_discharge WHERE activity_code = ? AND no_ppkb = ?"),
    @NamedNativeQuery(name = "RecapOtherPackage.Native.findVesselHandlingByPPKB", query = "SELECT nvl(SUM(m.amount)) as totpalka, nvl(SUM(m.total_charge)) as chargepalka, "
...
@NamedNativeQuery(name = "RecapOtherPackage.Native.findVesselHandlingByPPKBno", query = "SELECT nvl(SUM(m.amount)) as totpalka, nvl(SUM(m.total_charge)) as chargepalka, "
                ...
                + "t1.amount, t2.amount, t5.amount, t6.amount, t1.total_charge, t2.total_charge, t5.total_charge, t6.total_charge, "
                + "t3.amount, t4.amount, t7.amount, t8.amount, t3.total_charge, t4.total_charge, t7.total_charge, t8.total_charge"),
   @NamedNativeQuery(name = "RecapOtherPackage.Native.findByPpkb", query = "SELECT id FROM recap_handling_discharge WHERE no_ppkb = ?"),
   @NamedNativeQuery(name = "RecapOtherPackage.Native.countHandlingDischarge", query = "SELECT * FROM count_handling(?,?)")
})
public class RecapOtherPackage implements Serializable, EntityAuditable {
    ...
    public RecapOtherPackage() {
    }

    public RecapOtherPackage(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RecapOtherPackage)) {
            return false;
        }
        RecapOtherPackage other = (RecapOtherPackage) object;
    ...
    public String toString() {
        return "com.pelindo.ebtos.model.db.RecapOtherPackage[id=" + id + "]";
    }
}
