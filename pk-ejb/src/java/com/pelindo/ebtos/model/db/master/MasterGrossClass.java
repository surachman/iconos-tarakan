...
@NamedQueries({
    ...
    @NamedQuery(name = "MasterGrossClass.findByDescriptionOnChange", query = "SELECT m FROM MasterGrossClass m WHERE lower(m.description) = lower(:description)"),
    @NamedQuery(name = "MasterGrossClass.findByDescriptionOnChange2", query = "SELECT m FROM MasterGrossClass m WHERE lower(m.description) <> lower(:description) ")})
@NamedNativeQueries({
