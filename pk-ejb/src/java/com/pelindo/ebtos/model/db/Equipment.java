...
@NamedQueries({
    ...
    @NamedQuery(name = "Equipment.findIdByPPKBnContNo2", query = "SELECT e FROM Equipment e WHERE e.planningVessel.noPpkb = :noPpkb AND e.contNo = :contNo"),
...
@NamedNativeQueries({
    ...
    //penambahan start time
    //@NamedNativeQuery(name = "Equipment.Native.findByStartTimeData", query = "SELECT current_timestamp as start_time"),
    @NamedNativeQuery(name = "Equipment.Native.findByStartTimeData", query = "SELECT current_date as start_time from dual"),
    //@NamedNativeQuery(name = "Equipment.Native.findByEndTimeData", query = "SELECT current_timestamp + interval '61' as end_time"),    
    @NamedNativeQuery(name = "Equipment.Native.findByEndTimeData", query = "SELECT current_date + interval '61' second as end_time from dual"),
...
*/
    @NamedNativeQuery(name = "Equipment.Native.findByIdContainerReceivingPlug", query =     
"SELECT id " 
+"FROM " 
+"  (SELECT id " 
+"  FROM equipment " 
