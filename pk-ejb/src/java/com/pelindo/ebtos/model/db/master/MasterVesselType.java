...
@NamedQueries({
    ...
    @NamedNativeQueries({
    @NamedNativeQuery(name ="MasterVessel.Native.findMasterVesselType",query="SELECT m.vessel_type_code,m.name,m.tonage FROM m_vessel_type m order by m.vessel_type_code asc")})
