...
@NamedQueries({
    ...
    @NamedQuery(name = "Monitoring.findByContNo", query = "SELECT m FROM Monitoring m WHERE m.contNo = :contNo")})
public class Monitoring implements Serializable, EntityAuditable {
    ...
    public String toString() {
        return "com.pelindo.ebtos.model.db.Monitoring[id=" + id + "]";
    }
}
