...
@NamedQueries({
    ...
    @NamedNativeQueries({
    @NamedNativeQuery(name = "RecapPenumpukanTransload.Native.findRecapPenumpukanTransloadByPpkb", query = "SELECT r.id from recap_penumpukan_transload as r WHERE r.operation=? AND r.no_ppkb =?")})
