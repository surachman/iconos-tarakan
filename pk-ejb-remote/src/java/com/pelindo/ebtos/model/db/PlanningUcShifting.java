...
@Table(name = "planning_uc_shifting")
@NamedQueries({
    @NamedQuery(name = "PlanningUcShifting.findAll", query = "SELECT p FROM PlanningUcShifting p")
    })
@NamedNativeQueries({
    @NamedNativeQuery(name = "PlanningUcShifting.Native.findAllByPPKB", query = "SELECT a.no_bl, b.name, a.weight, c.name, d.name, change(a.truck_lossing), a.shift_to, a.id  FROM planning_uc_shifting a, m_commodity b, m_port c, m_port d WHERE a.commodity_code=b.commodity_code AND a.disch_port=c.port_code AND a.load_port=d.port_code AND a.no_ppkb=?")
    })
public class PlanningUcShifting implements Serializable, EntityAuditable {
    ...
    public PlanningUcShifting() {
    }

    public PlanningUcShifting(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlanningUcShifting)) {
            return false;
        }
        PlanningUcShifting other = (PlanningUcShifting) object;
    ...
    public String toString() {
        return "com.pelindo.ebtos.model.db.PlanningUcShifting[id=" + id + "]";
    }
