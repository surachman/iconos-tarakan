...
public class ChangeVesselService implements Serializable, EntityAuditable {
    ...
    public ChangeVesselService(Integer id, String contNo, short contSize, String contStatus, int contGross, boolean overSize, boolean dg, boolean dgLabel, boolean isExport, String position, BigDecimal charge, String createdBy, Date createdDate) {
        this.id = id;
        this.contNo = contNo;
