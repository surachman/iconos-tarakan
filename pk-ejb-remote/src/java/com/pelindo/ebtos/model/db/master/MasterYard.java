...
@NamedNativeQueries({
    @NamedNativeQuery(name="MasterYard.Native.findMasterYards",query="Select block, description, slot, row, tier, created_by, created_date, modified_by, modified_date, yard FROM m_yard ORDER BY block"),
