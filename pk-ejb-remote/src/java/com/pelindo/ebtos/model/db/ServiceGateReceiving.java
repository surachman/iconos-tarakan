...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "ServiceGateReceiving.Native.findReceivingCapacityStatusByNoPpkb", query = "SELECT nvl(SUM(sgr.cont_gross)) / 1000, COUNT(CASE WHEN mct.feet_mark = 20 THEN 1 WHEN mct.feet_mark = 40 THEN 2 END) "
