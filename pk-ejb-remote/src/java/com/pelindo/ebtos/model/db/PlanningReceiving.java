...
@NamedQueries({
    ...
    @NamedNativeQueries({
    @NamedNativeQuery(name = "PlanningReceiving.Native.findPlanningReceivingList", query="SELECT r.id, r.block,r.fr_slot,r.to_slot,r.fr_row,r.to_row,r.receiving_allocation_id FROM planning_receiving r, planning_receiving_allocation as p WHERE r.receiving_allocation_id=p.id AND r.receiving_allocation_id=? ORDER BY r.id DESC"),
    @NamedNativeQuery(name = "PlanningReceiving.Native.findPlanningReceivingAbmilIdContraint", query="SELECT r.id, r.block,r.fr_slot,r.to_slot,r.fr_row,r.to_row,r.receiving_allocation_id FROM planning_receiving r, planning_receiving_allocation as p WHERE r.receiving_allocation_id=p.id AND r.receiving_allocation_id=?"),
