...
public interface PlanningContReceivingFacadeRemote {
    ...
    List<Integer> findBaplieByConstraint(int cont_type, String cont_status, String gross_class, String commodity_code, boolean dg, boolean over_size, boolean isExport, String disch_port, String no_ppkb);
    ...
    Integer findPlanningCont(String cont_no,String no_ppkb,boolean is_generate);
    ...
    Integer findByContValidasiConstraint(String no_ppkb, int contSize, int contType, String contStatus, boolean overSize, boolean dg, boolean isEdit, String gross, String port);
