...
public interface MasterYardCoordinatFacadeRemote {
    ...
    public java.util.List<MasterYardCoordinat> findAvailableCoordinateByAllocationConstraint(String noPpkb, String portCode, Integer contSize, Integer contType, String contStatus, String grossClass, Boolean overSize, Boolean dg, Boolean isExport);
