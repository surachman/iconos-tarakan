...
public interface UcShiftingServiceFacadeRemote {
    ...
    Object[] findByPpkbBlNo(String no_ppkb, String bl_no, boolean is_reshipping);

    public java.util.List<com.pelindo.ebtos.model.db.UcShiftingService> findByNoPpkbAndReshippingStatus(java.lang.String noPpkb, java.lang.Boolean isReshipping);
