 ...
 * @author Dyware-Dev01
 */
@WebServlet(name = "Report15", urlPatterns = {"/Report15.pdf"})
public class Report15 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            map.put("bulan", bulan);
            map.put("tahun", tahun);
            report = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report15.jasper");
            response.setHeader("Content-Disposition", "inline; filename=\"MARKET_SHARE_BONGKAR_MUAT.pdf\"");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report15.class.getName()).log(Level.SEVERE, null, e);
            }
        }
    }
    ...
    private static void close(Connection resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report15.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
