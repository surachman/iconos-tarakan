 ...
 * @author Dyware-Dev01
 */
@WebServlet(name = "Report17", urlPatterns = {"/Report17.pdf"})
public class Report17 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            map.put("bulan", bulan);
            map.put("tahun", tahun);
            report = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report17.jasper");
            response.setHeader("Content-Disposition", "inline; filename=\"PRODUKSI_DAN_PENDAPATAN_PENUMPUKAN_KONV.pdf\"");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report17.class.getName()).log(Level.SEVERE, null, e);
            }
        }
    }
    ...
    private static void close(Connection resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report17.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
