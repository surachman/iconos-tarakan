 ...
 * @author Eka
 */
@WebServlet(name="BayMonitoring", urlPatterns={"/bayMonitoring.png"})
public class BayMonitoring extends HttpServlet {
    @EJB private ShipProfileBayMonitorRemote shipProfile;
...
//        String isLoad = request.getParameter("isLoad");
        ...
        try {
            shipProfile.initWithVesselAndPPKB(vesselCode, noPpkb, Integer.parseInt(bay),
                    width != null ? Integer.parseInt(width) : null,
                    height != null ? Integer.parseInt(height) : null, true);
        ...
        response.setHeader("Content-Disposition", "inline; filename=\"bayMonitoring.png\"");
