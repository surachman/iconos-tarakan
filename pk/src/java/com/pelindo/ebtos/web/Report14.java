 ...
 * @author Dyware-Dev01
 */
@WebServlet(name="Report14", urlPatterns={"/Report14.pdf"})
public class Report14 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            report = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report14.jasper");
            srDry = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report14A.jasper");
            srRefeer = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report14B.jasper");
            srJoin = loader.getResourceAsStream("/com/pelindo/ebtos/report/Report14C.jasper");
            response.setHeader("Content-Disposition", "inline; filename=\"REALISASI_ARUS_PETIKEMAS_TPB_KONVENSIONAL_DI_PELABUHAN_BITUNG_SD.pdf\"");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report14.class.getName()).log(Level.SEVERE, null, e);
            }
        }
    }
    ...
    private static void close(Connection resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(Report14.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
