 ...
 * @author wulan
 */
@WebServlet(name = "GateInReport", urlPatterns = "/GateInReport.pdf")
public class GateInReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "inline; filename=\"GateInReport_" + startDate + ".pdf\"");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(GateInReport.class.getName()).log(Level.SEVERE, null, e);
            }
        }
    }
    ...
    private static void close(Connection resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(GateInReport.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
