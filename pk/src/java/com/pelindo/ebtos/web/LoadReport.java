 ...
 * @author USER
 */
@WebServlet(name = "LoadReport", urlPatterns = {"/LoadReport.pdf"})
public class LoadReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            report = loader.getResourceAsStream("/com/pelindo/ebtos/report/LoadReport.jasper");
            detailSubreport = loader.getResourceAsStream("/com/pelindo/ebtos/report/LoadReport_detailSubreport.jasper");
            summarySubreport = loader.getResourceAsStream("/com/pelindo/ebtos/report/LoadReport_summarySubreport.jasper");
            ...
            response.setHeader("Content-Disposition", "inline; filename=\"LoadReport_" + noPpkb + ".pdf\"");
    ...
    private static void close(Closeable resource) {
        if (resource != null) {
            try {
                ...
                Logger.getLogger(LoadReport.class.getName()).log(Level.SEVERE, null, e);
            }
        }
    }
