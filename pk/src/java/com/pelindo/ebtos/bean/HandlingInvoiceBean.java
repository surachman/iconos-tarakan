 ...
 * @author dycoder
 */
@ManagedBean(name="handlingInvoiceBean")
@ViewScoped
public class HandlingInvoiceBean implements Serializable {
    ...
    private void prepareInvoiceCalculation() {
        List<Object[]> results = handlingInvoiceFacadeRemote.findContainerServicesChargeDetailByNoPpkb(planningVessel.getNoPpkb());
