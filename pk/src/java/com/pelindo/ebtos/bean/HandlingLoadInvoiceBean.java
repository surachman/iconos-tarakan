 ...
 * @author dycode-java
 */
@ManagedBean(name = "handlingLoadInvoiceBean")
@ViewScoped
public class HandlingLoadInvoiceBean implements Serializable {
    ...
    public HandlingLoadInvoiceBean() {}
    ...
    private void construct() {
        ...
        serviceVessels = serviceVesselFacadeRemote.findServiceVesselsServicedLoad();
    ...
    private void prepareInvoiceCalculation() {
        List<Object[]> results = handlingInvoiceFacadeRemote.findContainerServicesChargeDetailLoadByNoPpkb(planningVessel.getNoPpkb());
