 ...
 * @author USER
 */
@ManagedBean(name="handlingLoadPreviewBean")
@ViewScoped
public class HandlingLoadPreviewBean implements Serializable{
    ...
    public HandlingLoadPreviewBean() {
//        serviceVessels = serviceVesselFacadeRemote.findServiceVesselsServiced();
        serviceVessels = serviceVesselFacadeRemote.findServiceVesselsServicingLoad();
    }
